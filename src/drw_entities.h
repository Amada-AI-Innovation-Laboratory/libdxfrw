...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Entity {
    SETENTFRIENDS
public:
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Point : public DRW_Entity {
    SETENTFRIENDS
public:
    DRW_Point() {
        eType = DRW::POINT;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Line : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Line() {
        eType = DRW::LINE;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Ray : public DRW_Line {
    SETENTFRIENDS
public:
    DRW_Ray() {
        eType = DRW::RAY;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Xline : public DRW_Ray {
public:
    DRW_Xline() {
        eType = DRW::XLINE;
    }
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Circle : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Circle() {
        eType = DRW::CIRCLE;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Arc : public DRW_Circle {
    SETENTFRIENDS
public:
    DRW_Arc() {
        eType = DRW::ARC;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Ellipse : public DRW_Line {
    SETENTFRIENDS
public:
    DRW_Ellipse() {
        eType = DRW::ELLIPSE;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Trace : public DRW_Line {
    SETENTFRIENDS
public:
    DRW_Trace() {
        eType = DRW::TRACE;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Solid : public DRW_Trace {
    SETENTFRIENDS
public:
    DRW_Solid() {
        eType = DRW::SOLID;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_3Dface : public DRW_Trace {
    SETENTFRIENDS
public:
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Block : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Block() {
        eType = DRW::BLOCK;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Insert : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Insert() {
        eType = DRW::INSERT;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_LWPolyline : public DRW_Entity {
    SETENTFRIENDS
public:
    DRW_LWPolyline() {
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Text : public DRW_Line {
    SETENTFRIENDS
public:
    //! Vertical alignments.
        enum VAlign {
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_MText : public DRW_Text {
    SETENTFRIENDS
public:
    //! Attachments.
    enum Attach {
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Vertex : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Vertex() {
        eType = DRW::VERTEX;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Polyline : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Polyline() {
        eType = DRW::POLYLINE;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Spline : public DRW_Entity {
    SETENTFRIENDS
public:
    DRW_Spline() {
        eType = DRW::SPLINE;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_HatchLoop {
public:
    DRW_HatchLoop(int t) {
        type = t;
        numedges = 0;
...
class LIBDXFRW_DLL_EXPORTED DRW_Hatch : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Hatch() {
        eType = DRW::HATCH;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Image : public DRW_Line {
    SETENTFRIENDS
public:
    DRW_Image() {
        eType = DRW::IMAGE;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Dimension : public DRW_Entity {
    SETENTFRIENDS
public:
    DRW_Dimension() {
        eType = DRW::DIMENSION;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_DimAligned : public DRW_Dimension {
    SETENTFRIENDS
public:
    DRW_DimAligned(){
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_DimLinear : public DRW_DimAligned {
public:
    DRW_DimLinear() {
        eType = DRW::DIMLINEAR;
    }
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_DimRadial : public DRW_Dimension {
    SETENTFRIENDS
public:
    DRW_DimRadial() {
        eType = DRW::DIMRADIAL;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_DimDiametric : public DRW_Dimension {
    SETENTFRIENDS
public:
    DRW_DimDiametric() {
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_DimAngular : public DRW_Dimension {
    SETENTFRIENDS
public:
    DRW_DimAngular() {
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_DimAngular3p : public DRW_Dimension {
    SETENTFRIENDS
public:
    DRW_DimAngular3p() {
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_DimOrdinate : public DRW_Dimension {
    SETENTFRIENDS
public:
    DRW_DimOrdinate() {
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Leader : public DRW_Entity {
    SETENTFRIENDS
public:
    DRW_Leader() {
        eType = DRW::LEADER;
...
*  @author Rallaz
*/
class LIBDXFRW_DLL_EXPORTED DRW_Viewport : public DRW_Point {
    SETENTFRIENDS
public:
    DRW_Viewport() {
        eType = DRW::VIEWPORT;
